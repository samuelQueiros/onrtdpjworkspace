    ...
    <div className="layout">
      <aside className="sidebar">
        <div className="sidebar-logo">
          ...
          <span className="logo-text">Férias<span>RH</span></span>
        </div>
      ...
      <div className="main-area">
        <header className="topbar">
          <div>
            <div className="topbar-title">{PAGES[location.pathname] ?? 'FériasRH'}</div>
            <div className="topbar-sub">Sistema de Gestão de Férias — ONRTDPJ</div>
          </div>
