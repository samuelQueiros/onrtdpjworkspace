...
class FichaAdmissionalSelfUpdate(BaseModel):
    """Subconjunto de campos que o proprio colaborador pode editar.

    Deliberadamente NAO herda de FichaAdmissionalUpdate: campos financeiros/
    contratuais (salario, horario_trabalho, dias_semana, vale_transporte,
    beneficios, valor_beneficios, contrato_experiencia_dias, status) ficam de
    fora por construcao, para que nunca possam ser alterados via autoatendimento.
    """
